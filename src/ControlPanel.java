...
public class ControlPanel extends Component {
    ...
    public ControlPanel(Screen screen) {
        ...
        l1.setFont(new Font("Arial",Font.BOLD,16));// Set position and size
        cp.add(l1);
        ...
        k1JLabel.setForeground(Color.WHITE);
        cp.add(k1JLabel);
        ...
        k2JLabel.setForeground(Color.WHITE);
        cp.add(k2JLabel);
        ...
        k3JLabel.setForeground(Color.WHITE);
        cp.add(k3JLabel);
